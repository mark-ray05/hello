...
import { idlFactory } from './hello3_backend.did.js';
export { idlFactory } from './hello3_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HELLO3_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello3_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello3_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello3_backend.did.js")._SERVICE>}
 */
export const hello3_backend = createActor(canisterId);
