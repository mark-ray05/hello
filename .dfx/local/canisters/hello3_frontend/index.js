...
import { idlFactory } from './hello3_frontend.did.js';
export { idlFactory } from './hello3_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HELLO3_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello3_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello3_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello3_frontend.did.js")._SERVICE>}
 */
export const hello3_frontend = createActor(canisterId);
